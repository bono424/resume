        ...
        if User.first(:email => "s@siddarthc.com").nil?
          begin
            Employer.create(
              ...
              :name => "MyGrad",
              :handle => "mygrad",
              :url => "http://mygrad.com.au",
              :description => "MyGrad helps you connect with top employers and recruiters. We help to put you in a position to be considered for internships and full time positions by the banks, consulting firms, public service groups, and other firms that we partner with.",
              :founded => 2011,
